...
@Component({
  selector: 'app-create-account-ag-level-approved',
  templateUrl: './create-account-ag-level-approved.component.html',
  styleUrls: ['./create-account-ag-level-approved.component.css']
})
export class CreateAccountAgLevelApprovedComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.agLevelApprovedForm = this.fb.group({
      // Formfields
      subTreasuryName: [''],
      treasuryName: ['1'],
      ddoNo: [''],
  ...
  // routing
  gotoListing() {
    this.router.navigate(['./pdpla/create-account-ag-level-approved-listing']);
  }
