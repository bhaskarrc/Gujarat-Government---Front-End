...
@Component({
  selector: 'app-refund-request-administrator',
  templateUrl: './refund-request-administrator.component.html',
  styleUrls: ['./refund-request-administrator.component.css']
})
export class RefundRequestAdministratorComponent implements OnInit {
  ...
  // routing
  gotoListing() {
    this.router.navigate(['./pdpla/refund-request-listing-administrator']);
  }
}
