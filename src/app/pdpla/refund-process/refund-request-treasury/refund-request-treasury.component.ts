...
@Component({
  selector: 'app-refund-request-treasury',
  templateUrl: './refund-request-treasury.component.html',
  styleUrls: ['./refund-request-treasury.component.css']
})
export class RefundRequestTreasuryComponent implements OnInit {
  // Form Group
  pdplaform: FormGroup;
  // Date
  todayDate = Date.now();
  ...
  // routing
  gotoListing() {
    this.router.navigate(['./pdpla/refund-request-listing-treasury']);
  }
