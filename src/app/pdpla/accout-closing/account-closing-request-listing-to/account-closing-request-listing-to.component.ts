...
import { ListValue, CreateAcListAccountDAte } from 'src/app/model/pdpla';

@Component({
  selector: 'app-account-closing-request-listing-to',
  templateUrl: './account-closing-request-listing-to.component.html',
  styleUrls: ['./account-closing-request-listing-to.component.css']
})
export class AccountClosingRequestListingToComponent implements OnInit {
  pdplaform: FormGroup;
