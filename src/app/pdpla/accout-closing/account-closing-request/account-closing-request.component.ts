...
@Component({
  selector: 'app-account-closing-request',
  templateUrl: './account-closing-request.component.html',
  styleUrls: ['./account-closing-request.component.css']
})
export class AccountClosingRequestComponent implements OnInit {
  todayDate = Date.now();
