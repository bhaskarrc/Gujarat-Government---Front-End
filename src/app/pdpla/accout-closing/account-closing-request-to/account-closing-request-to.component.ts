...
@Component({
  selector: 'app-account-closing-request-to',
  templateUrl: './account-closing-request-to.component.html',
  styleUrls: ['./account-closing-request-to.component.css']
})
export class AccountClosingRequestToComponent implements OnInit {
  // Date
  todayDate = Date.now();
  // Form Group
  pdplaform: FormGroup;
  ...
  // routing
  gotoListing() {
    this.router.navigate(['./pdpla/create-account-closing-request-listing-to']);
  }
