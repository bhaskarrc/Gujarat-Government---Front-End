...
@Component({
  selector: 'app-create-account-parent-department-level',
  templateUrl: './create-account-parent-department-level.component.html',
  styleUrls: ['./create-account-parent-department-level.component.css']
})
export class CreateAccountParentDepartmentLevelComponent implements OnInit {
  // Date
  todayDate = Date.now();
  ...
  ngOnInit() {
    ...
    this.parentLevelForm = this.fb.group({
      // Formfields
      subTreasuryName: [''],
      treasuryName: ['1'],
      ddoNo: [''],
  ...
  // routing
  gotoListing() {
    this.router.navigate(['./pdpla/create-account-listing-admin']);
  }
