...
@Component({
    selector: 'app-workflow-details-pdpla',
    templateUrl: './workflow-details-pdpla.component.html',
    styleUrls: ['./workflow-details-pdpla.component.css']
})
export class WorkflowDetailsPdplaComponent implements OnInit {
    ...
    headerJso: HeaderElement[] = [
        ...
        { label: 'Major Head', value: '8448: Art and Culture' },
        { label: 'Sub Major Head', value: '01 ' },
        { label: 'Minor Head', value: '101: National Mineral Exploration Trust Deposite' },
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsPdplaComponent>,
