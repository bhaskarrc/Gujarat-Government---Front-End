...
import { SurpriseVerifList } from 'src/app/model/stamp-processing';


// Listing table Data
const ELEMENT_DATA: SurpriseVerifList[] = [
  {
    fYear: '2019-2020',
  ...
  {
    fYear: '2019-2020',
    toffice: 'Sub Treasury Office, Sanand, Ahmedabad',
    veriType: 'Surprise Verification',
    rNumber: '51/00057/072019/23',
...
@Component({
  selector: 'app-surprise-verification-to-list',
  templateUrl: './surprise-verification-to-list.component.html',
  styleUrls: ['./surprise-verification-to-list.component.css']
})
export class SurpriseVerificationToListComponent implements OnInit {
...
// Listing Table
  ...
  surpriseVerificationToListForm: FormGroup;
  ...
  createForm() {
    this.surpriseVerificationToListForm = this.fb.group({
  ...
  clearForm() {
    this.surpriseVerificationToListForm.reset();
  }
// Delete
  delete(index) {
