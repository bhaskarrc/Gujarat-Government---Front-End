...
@Component({
  selector: 'app-preparation-of-challan-sto-list',
  templateUrl: './preparation-of-challan-sto-list.component.html',
  styleUrls: ['./preparation-of-challan-sto-list.component.css']
})
export class PreparationOfChallanStoListComponent implements OnInit {
...
// Listing Table
    displayedColumns: string[] = ['position', 'fYear', 'rNumber', 'rDate', 'cNumber', 'cDate', 'vendor', 'status', 'action'];
