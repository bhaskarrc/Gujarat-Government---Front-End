...
@Component({
  selector: 'app-cancel-challan-authorization-sto-view',
  templateUrl: './cancel-challan-authorization-sto-view.component.html',
  styleUrls: ['./cancel-challan-authorization-sto-view.component.css']
})
export class CancelChallanAuthorizationStoViewComponent implements OnInit {
