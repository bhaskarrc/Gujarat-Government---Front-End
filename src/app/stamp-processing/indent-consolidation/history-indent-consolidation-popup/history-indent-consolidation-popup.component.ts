...
@Component({
  selector: 'app-history-indent-consolidation-popup',
  templateUrl: './history-indent-consolidation-popup.component.html',
  styleUrls: ['./history-indent-consolidation-popup.component.css']
})
export class HistoryIndentConsolidationPopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<HistoryIndentConsolidationPopupComponent>,
