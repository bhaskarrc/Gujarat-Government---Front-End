...
@Component({
  selector: 'app-indent-consolidation-workflow',
  templateUrl: './indent-consolidation-workflow.component.html',
  styleUrls: ['./indent-consolidation-workflow.component.css']
})
export class IndentConsolidationWorkflowComponent implements OnInit {
  ...
  currentLang = new BehaviorSubject<string>('Eng');
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<IndentConsolidationWorkflowComponent>,
