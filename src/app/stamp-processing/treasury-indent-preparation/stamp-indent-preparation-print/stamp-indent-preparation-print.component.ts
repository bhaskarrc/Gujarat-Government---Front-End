...
@Component({
  selector: 'app-stamp-indent-preparation-print',
  templateUrl: './stamp-indent-preparation-print.component.html',
  styleUrls: ['./stamp-indent-preparation-print.component.css']
})
export class StampIndentPreparationPrintComponent implements OnInit {
