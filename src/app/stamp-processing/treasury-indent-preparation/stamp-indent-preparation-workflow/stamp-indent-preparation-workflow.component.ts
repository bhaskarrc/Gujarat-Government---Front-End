...
@Component({
  selector: 'app-stamp-indent-preparation-workflow',
  templateUrl: './stamp-indent-preparation-workflow.component.html',
  styleUrls: ['./stamp-indent-preparation-workflow.component.css']
})
export class StampIndentPreparationWorkflowComponent implements OnInit {
  ...
  currentLang = new BehaviorSubject<string>('Eng');
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<StampIndentPreparationWorkflowComponent>,
