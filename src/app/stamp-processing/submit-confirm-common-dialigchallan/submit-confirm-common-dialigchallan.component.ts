...
@Component({
    selector: 'app-submit-confirm-common-dialigchallan',
    templateUrl: './submit-confirm-common-dialigchallan.component.html',
    styleUrls: ['./submit-confirm-common-dialigchallan.component.css']
})
export class SubmitConfirmCommonChallanDialigComponent implements OnInit {
    ...
    headerJso: HeaderElement[] = [
        ...
        { label: 'Date of Cancel Challan Authorization', value: '1-Oct-2020' },
        { label: 'Challan Amount', value: '23500' },
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<SubmitConfirmCommonChallanDialigComponent>,
