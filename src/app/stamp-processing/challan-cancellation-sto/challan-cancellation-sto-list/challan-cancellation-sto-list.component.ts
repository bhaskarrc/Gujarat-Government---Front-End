...
import { ElementChallanCanList } from 'src/app/model/stamp-processing';

// Listing table Data
const ELEMENT_DATA: ElementChallanCanList[] = [
  {
    fYear: '2019-2020',
    refDate: '14-Apr-2019',
...
@Component({
  selector: 'app-challan-cancellation-sto-list',
  templateUrl: './challan-cancellation-sto-list.component.html',
  styleUrls: ['./challan-cancellation-sto-list.component.css']
})
export class ChallanCancellationStoListComponent implements OnInit {
