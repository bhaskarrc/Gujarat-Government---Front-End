...
import { ElementSingleDoubleStoList } from 'src/app/model/stamp-processing';

// Listing table Data
const ELEMENT_DATA: ElementSingleDoubleStoList[] = [
  {
    fYear: '2019-2020',
...
@Component({
  selector: 'app-single-double-lock-stoffice-list',
  templateUrl: './single-double-lock-stoffice-list.component.html',
  styleUrls: ['./single-double-lock-stoffice-list.component.css']
})
export class SingleDoubleLockStofficeListComponent implements OnInit {
...
// Listing Table
  ...
  createForm() {
    this.sdlockListForm = this.fb.group({
      finYear: ['10'],
      fromDate: [''],
      toDate: [''],
      status: [''],
