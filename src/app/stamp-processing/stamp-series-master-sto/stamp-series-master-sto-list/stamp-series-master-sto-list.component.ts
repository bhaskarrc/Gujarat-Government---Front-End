...
@Component({
  selector: 'app-stamp-series-master-sto-list',
  templateUrl: './stamp-series-master-sto-list.component.html',
  styleUrls: ['./stamp-series-master-sto-list.component.css']
})
export class StampSeriesMasterStoListComponent implements OnInit {
