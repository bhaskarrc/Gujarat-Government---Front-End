...
@Component({
  selector: 'app-history-prep-challan-totsheet-popup',
  templateUrl: './history-prep-challan-totsheet-popup.component.html',
  styleUrls: ['./history-prep-challan-totsheet-popup.component.css']
})
export class HistoryPrepChallanTotsheetPopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<HistoryPrepChallanTotsheetPopupComponent>,
