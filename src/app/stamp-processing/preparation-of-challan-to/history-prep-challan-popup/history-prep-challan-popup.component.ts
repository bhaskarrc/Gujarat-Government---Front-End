...
@Component({
  selector: 'app-history-prep-challan-popup',
  templateUrl: './history-prep-challan-popup.component.html',
  styleUrls: ['./history-prep-challan-popup.component.css']
})
export class HistoryPrepChallanPopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<HistoryPrepChallanPopupComponent>,
