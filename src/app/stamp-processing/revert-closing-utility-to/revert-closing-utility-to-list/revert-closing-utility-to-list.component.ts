...
@Component({
  selector: 'app-revert-closing-utility-to-list',
  templateUrl: './revert-closing-utility-to-list.component.html',
  styleUrls: ['./revert-closing-utility-to-list.component.css']
})
export class RevertClosingUtilityToListComponent implements OnInit {
  ...
  RevertClosingUtilityToListForm: FormGroup;
  ...
  createForm() {
    this.RevertClosingUtilityToListForm = this.fb.group({
  ...
  clearForm() {
    this.RevertClosingUtilityToListForm.reset();
  }
