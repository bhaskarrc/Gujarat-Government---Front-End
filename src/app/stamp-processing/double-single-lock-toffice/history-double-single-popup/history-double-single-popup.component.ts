...
@Component({
  selector: 'app-history-double-single-popup',
  templateUrl: './history-double-single-popup.component.html',
  styleUrls: ['./history-double-single-popup.component.css']
})
export class HistoryDoubleSinglePopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<HistoryDoubleSinglePopupComponent>,
