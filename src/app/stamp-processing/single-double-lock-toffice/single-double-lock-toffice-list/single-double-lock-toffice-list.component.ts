...
import { ElementSingleDoubleList } from 'src/app/model/stamp-processing';


// Listing table Data
const ELEMENT_DATA: ElementSingleDoubleList[] = [
  {
    fYear: '2019-2020',
...
@Component({
  selector: 'app-single-double-lock-toffice-list',
  templateUrl: './single-double-lock-toffice-list.component.html',
  styleUrls: ['./single-double-lock-toffice-list.component.css']
})
export class SingleDoubleLockTofficeListComponent implements OnInit {
