...
import { ElementDoubleSingleTo, ElementSingleDoubleTo } from 'src/app/model/stamp-processing';
...
@Component({
  selector: 'app-single-double-lock-toffice-view',
  templateUrl: './single-double-lock-toffice-view.component.html',
  styleUrls: ['./single-double-lock-toffice-view.component.css']
})
export class SingleDoubleLockTofficeViewComponent implements OnInit {
