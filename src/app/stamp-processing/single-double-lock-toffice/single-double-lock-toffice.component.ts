...
import { ElementDoubleSingleTo, ElementSingleDoubleManual, ElementSingleDoubleManualFinal } from 'src/app/model/stamp-processing';
...
const ELEMENT_DATA_MAN: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
const ELEMENT_DATA2_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
const ELEMENT_DATA3_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '1',
    availQty: '10',
...
const ELEMENT_DATA4_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '100',
    availQty: '10',
...
]; const ELEMENT_DATA5_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA6_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA7_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA8_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA9_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA10_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA11_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
]; const ELEMENT_DATA12_Man: ElementSingleDoubleManual[] = [
  {
    checkbox: false,
    denomination: '5',
    availQty: '10',
...
const ELEMENT_DATA_ManFINAL: ElementSingleDoubleManualFinal[] = [
  {
...
const ELEMENT_DATA_ManFINAL2: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL3: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL4: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL5: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL6: ElementSingleDoubleManualFinal[] = [
  {
    typeOfStamp: 'Hundi',
    denomination: '1',
    availQty: '10',
...
]; const ELEMENT_DATA_ManFINAL7: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL8: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL9: ElementSingleDoubleManualFinal[] = [
  {
    typeOfStamp: 'Notary',
    denomination: '1',
    availQty: '10',
...
]; const ELEMENT_DATA_ManFINAL10: ElementSingleDoubleManualFinal[] = [
  {
    typeOfStamp: 'Revenue',
    denomination: '1',
    availQty: '10',
...
]; const ELEMENT_DATA_ManFINAL11: ElementSingleDoubleManualFinal[] = [
  {
...
]; const ELEMENT_DATA_ManFINAL12: ElementSingleDoubleManualFinal[] = [
  {
...
@Component({
  selector: 'app-single-double-lock-toffice',
  templateUrl: './single-double-lock-toffice.component.html',
  styleUrls: ['./single-double-lock-toffice.component.css']
})
export class SingleDoubleLockTofficeComponent implements OnInit {
  // Entry Field Details
...
// Challan Mode
  ...
  gotoListing() {
    this.router.navigate(['./stamp-processing/single-double-lock-toffice-list']);
  }
}
