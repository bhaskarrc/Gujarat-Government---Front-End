...
@Component({
  selector: 'app-history-button-popup',
  templateUrl: './history-button-popup.component.html',
  styleUrls: ['./history-button-popup.component.css']
})
export class HistoryButtonPopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<HistoryButtonPopupComponent>,
