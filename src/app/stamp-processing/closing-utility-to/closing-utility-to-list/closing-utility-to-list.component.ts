...
@Component({
  selector: 'app-closing-utility-to-list',
  templateUrl: './closing-utility-to-list.component.html',
  styleUrls: ['./closing-utility-to-list.component.css']
})
export class ClosingUtilityToListComponent implements OnInit {
...
// Listing Table
  ...
  closingUtilityToListForm: FormGroup;
  ...
  createForm() {
    this.closingUtilityToListForm = this.fb.group({
  ...
  clearForm() {
    this.closingUtilityToListForm.reset();
  }
