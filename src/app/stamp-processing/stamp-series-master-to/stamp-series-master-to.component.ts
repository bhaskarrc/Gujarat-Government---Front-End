...
const ELEMENT_DATA2: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA3: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA4: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA5: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA6: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA7: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA8: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA9: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA10: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA11: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
const ELEMENT_DATA12: StampSeriesMaster[] = [
  {
    denomination: '1',
    unitValue: '',
    stampSheet: '',
...
@Component({
  selector: 'app-stamp-series-master-to',
  templateUrl: './stamp-series-master-to.component.html',
  styleUrls: ['./stamp-series-master-to.component.css']
})
export class StampSeriesMasterToComponent implements OnInit {
// Entry Field Details
  ...
  activeInactive_list: CommonListing[] = [
  ...
  displayedColumns: string[] = ['position', 'denomination', 'unitValue', 'labelSheet',
    'stampSheet', 'from', 'to', 'activeInactive'];

  stampCtrl: FormControl = new FormControl();
  finYearCtrl: FormControl = new FormControl();
  activeInactiveCtrl: FormControl = new FormControl();
  errorMessages = stampProcessMessage;
  stampMasterToForm: FormGroup;
  date: any = new Date();
  ...
  createForm() {
    this.stampMasterToForm = this.fb.group({
...
// Add Button Click
  whenAddClick() {
    this.stampVal = this.stampMasterToForm.controls.stamp.value;
  ...
  gotoListing() {
    this.router.navigate(['./stamp-processing/stamp-series-master-to-list']);
  }
