...
@Component({
  selector: 'app-stamp-series-master-to-view',
  templateUrl: './stamp-series-master-to-view.component.html',
  styleUrls: ['./stamp-series-master-to-view.component.css']
})
export class StampSeriesMasterToViewComponent implements OnInit {
  ...
  stampMasterToViewForm: FormGroup;
  date: any = new Date();
  ...
  createForm() {
    this.stampMasterToViewForm = this.fb.group({
      finYear: ['10'],
      toffice: [''],
      challan: ['1'],
    });
