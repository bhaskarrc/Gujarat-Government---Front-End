...
@Component({
  selector: 'app-stamp-issue-sto',
  templateUrl: './stamp-issue-sto.component.html',
  styleUrls: ['./stamp-issue-sto.component.css']
})
export class StampIssueStoComponent implements OnInit {
// Entry Field Details
