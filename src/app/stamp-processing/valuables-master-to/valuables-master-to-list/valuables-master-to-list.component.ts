...
@Component({
  selector: 'app-valuables-master-to-list',
  templateUrl: './valuables-master-to-list.component.html',
  styleUrls: ['./valuables-master-to-list.component.css']
})
export class ValuablesMasterToListComponent implements OnInit {
