...
@Component({
  selector: 'app-valuables-master-to',
  templateUrl: './valuables-master-to.component.html',
  styleUrls: ['./valuables-master-to.component.css']
})
export class ValuablesMasterToComponent implements OnInit {
// Entry Field Details
