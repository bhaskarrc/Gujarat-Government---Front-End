...
import { ReceiptManagementDirective } from 'src/app/common/directive/receipt-management';
...
export class RegistrationViewComponent implements OnInit {
  ...
  rmDirectiveObj = new ReceiptManagementDirective(this.dialog);
  // form controls
  ...
  hod_list: ListValue[] = [
    ...
    { value: '5', viewValue: 'Commisioner of commercial tax' }
  ];
