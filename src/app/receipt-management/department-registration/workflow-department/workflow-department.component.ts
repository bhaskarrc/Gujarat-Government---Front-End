...
@Component({
    selector: 'app-workflow-department',
    templateUrl: './workflow-department.component.html',
    styleUrls: ['./workflow-department.component.css']
})
export class WorkflowDepartmentComponent implements OnInit {
    // variables
    ...
    headerJso: HeaderElement[] = [
        { label: 'Tax Authority ', value: 'Gujarat State' },
        { label: 'Name', value: 'Mr. ABC' },
        { label: 'Department', value: 'Home Department' },
        { label: 'Department', value: 'Pay & Accounts Office Ahmedabad' },
        { label: 'Purpose code', value: 'Ready Built House' },
    ];
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDepartmentComponent>,
