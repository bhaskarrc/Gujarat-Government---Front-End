...
@Component({
  selector: 'app-bank-rate-master-ha',
  templateUrl: './bank-rate-master-ha.component.html',
  styleUrls: ['./bank-rate-master-ha.component.css']
})
export class BankRateMasterHaComponent implements OnInit {
  ...
  navigate() {
    this.router.navigate(['./e-pao/bank-rate-master-ha-listing']);
  }
}
