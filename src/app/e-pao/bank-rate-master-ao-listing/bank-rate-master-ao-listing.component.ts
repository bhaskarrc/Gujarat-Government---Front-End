...
@Component({
  selector: 'app-bank-rate-master-ao-listing',
  templateUrl: './bank-rate-master-ao-listing.component.html',
  styleUrls: ['./bank-rate-master-ao-listing.component.css']
})
export class BankRateMasterAoListingComponent implements OnInit {
