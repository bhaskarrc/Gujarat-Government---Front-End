...
@Component({
  selector: 'app-gst-filr-accounting-ha',
  templateUrl: './gst-filr-accounting-ha.component.html',
  styleUrls: ['./gst-filr-accounting-ha.component.css']
})
export class GstFilrAccountingHaComponent implements OnInit {
  ...
  navigate() {
    this.router.navigate(['./e-pao/gst-file-accounting-ha-listing']);
  }
