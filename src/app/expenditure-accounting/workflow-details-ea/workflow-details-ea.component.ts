...
import { DialogData } from 'src/app/model/ea';
declare function SetGujarati();
declare function SetEnglish();

@Component({
  selector: 'app-workflow-details-ea',
  templateUrl: './workflow-details-ea.component.html',
  styleUrls: ['./workflow-details-ea.component.css']
})
export class WorkflowDetailsEaComponent implements OnInit {
  ...
  constructor(private elem: ElementRef,
    ...
    public dialogRef: MatDialogRef<WorkflowDetailsEaComponent>,
