...
@Component({
  selector: 'app-submit-account',
  templateUrl: './submit-account.component.html',
  styleUrls: ['./submit-account.component.css']
})
export class SubmitAccountComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.submitAccountForm = this.fb.group({
      // FormGroup Fields
      year: '',
      month: '',
