...
@Component({
  selector: 'app-submit-account-to-nps',
  templateUrl: './submit-account-to-nps.component.html',
  styleUrls: ['./submit-account-to-nps.component.css']
})
export class SubmitAccountToNpsComponent implements OnInit {
  directiveObject = new EaDirectives(this.dialog);
  initiatiomdate = new Date((new Date()));
  errorMessages = eaMessage;
  isSubmitted = false;
  // FormGroup
  submitAccountNpsForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.submitAccountNpsForm = this.fb.group({
      // FormGroup Fields
      year: '',
      month: '',
  ...
  onSave() {
    if (this.submitAccountNpsForm.valid) {
