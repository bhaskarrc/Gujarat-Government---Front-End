...
@Component({
  selector: 'app-upload-bank-scroll-payment-list',
  templateUrl: './upload-bank-scroll-payment-list.component.html',
  styleUrls: ['./upload-bank-scroll-payment-list.component.css']
})
export class UploadBankScrollPaymentListComponent implements OnInit {
  // FormGroup
  uploadBankPaymentListForm: FormGroup;
  // FormControl
  ...
  ngOnInit() {
    this.uploadBankPaymentListForm = this.fb.group({
      // FormGroup Fields
      passingDate: [''],
      type: ['Adjustment'],
      detailHead: ['1234'],
