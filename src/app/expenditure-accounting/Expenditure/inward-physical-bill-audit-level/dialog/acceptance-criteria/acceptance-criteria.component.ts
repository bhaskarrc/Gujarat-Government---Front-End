...
import { BillHistoryPaoBillComponent } from './bill-history/bill-history.component';
...
export class AcceptanceCriteriaComponent implements OnInit {
  ...
  challandisplayedColumns: string[] = ['checkBox', 'coded', 'challanNo', 'refNo',
    'tokenNo', 'billdate', 'chequeamount', 'amount', 'action'];
  constructor(
  ...
  paidamounthis() {
    const dialogRef = this.dialog.open(BillHistoryPaoBillComponent, {
      width: '800px'
    });
