...
@Component({
  selector: 'app-submit-account-to-dppf',
  templateUrl: './submit-account-to-dppf.component.html',
  styleUrls: ['./submit-account-to-dppf.component.css']
})
export class SubmitAccountToDppfComponent implements OnInit {
  ...
  isSubmitted = false;
  // FormGroup
  submitAccountDppfForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.submitAccountDppfForm = this.fb.group({
      // FormGroup Fields
      year: '',
      month: '',
  ...
  onSave() {
    if (this.submitAccountDppfForm.valid) {
