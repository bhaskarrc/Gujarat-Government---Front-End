...
@Component({
  selector: 'app-upload-bank-scroll-payment',
  templateUrl: './upload-bank-scroll-payment.component.html',
  styleUrls: ['./upload-bank-scroll-payment.component.css']
})
export class UploadBankScrollPaymentComponent implements OnInit {
  // FormGroup
  uploadBankPaymentForm: FormGroup;
  // FormControl
  ...
  ngOnInit() {
    this.uploadBankPaymentForm = this.fb.group({
      // FormGroup Fields
      passingDate: [''],
      type: ['Adjustment'],
      detailHead: ['1234'],
