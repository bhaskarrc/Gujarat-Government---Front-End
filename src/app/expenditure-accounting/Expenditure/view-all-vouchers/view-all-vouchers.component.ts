...
@Component({
  selector: 'app-view-all-vouchers',
  templateUrl: './view-all-vouchers.component.html',
  styleUrls: ['./view-all-vouchers.component.css']
})
export class ViewAllVouchersComponent implements OnInit {
