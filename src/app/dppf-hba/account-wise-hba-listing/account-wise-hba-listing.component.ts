...
import { AccountWiseHbaListingVoucherScreen } from './../../model/dppf-hba';
...
@Component({
  selector: 'app-account-wise-hba-listing',
  templateUrl: './account-wise-hba-listing.component.html',
  styleUrls: ['./account-wise-hba-listing.component.css']
})
export class AccountWiseHbaListingComponent implements OnInit {
  ...
  Element_Data: AccountWiseHbaListingVoucherScreen[] = [
    {
      srno: '1',
...

    {
      ...
      month: 'Aug',
      paymentType: 'Debit',
      inwardType: 'Request for Account Generation',
    },

    {
      ...
      month: 'Aug',
      paymentType: 'Credit',
      inwardType: 'AGTE Misclassified Entry',
    },
  ...
  dataSource = new MatTableDataSource<AccountWiseHbaListingVoucherScreen>(this.Element_Data);
  ...
  // Navigate route
  navigate() {
    this.router.navigate(['./dppf-hba/account-wise-entry']);
  }
}
