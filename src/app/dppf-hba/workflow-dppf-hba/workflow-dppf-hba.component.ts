...
@Component({
  selector: 'app-workflow-dppf-hba',
  templateUrl: './workflow-dppf-hba.component.html',
  styleUrls: ['./workflow-dppf-hba.component.css']
})
export class WorkflowDppfHbaComponent implements OnInit {
  ...
  constructor(private elem: ElementRef,
    ...
    public dialogRef: MatDialogRef<WorkflowDppfHbaComponent>,
