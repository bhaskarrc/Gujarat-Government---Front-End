...
const HISTORY_DATA: any[] = [
  { userRole: 'Creator', userSortName: 'Shri S M Modi', userCode: 'GAD12345', detailHeadCode: '00',
  detailHeadDesEng: 'Description', detailHeadDesGuj: 'ગુજરાતી',
  designation: 'HOD', dateAndTime1: '28-Apr-2020',
  dateAndTime: `${todayDate.getDate()}/${todayDate.getMonth()}/${todayDate.getFullYear()}`,

  proposedAmt: 100.00, remark: ''},
  { userRole: 'Verifier', userSortName: 'Shri P J Patel', userCode: 'GAGUJ23231', detailHeadCode: '00',
  detailHeadDesEng: 'Description', detailHeadDesGuj: 'ગુજરાતી',
  designation: 'HOD', dateAndTime1: '28-Apr-2020',
  dateAndTime: `${todayDate.getDate()}/${todayDate.getMonth()}/${todayDate.getFullYear()}`,
  proposedAmt: 200.00, remark: 'We may approve.'},

  { userRole: 'Verifier', userSortName: 'Shri S M Jani', userCode: 'GAGUJ23343', detailHeadCode: '00',
  detailHeadDesEng: 'Description', detailHeadDesGuj: 'ગુજરાતી',
  designation: 'HOD', dateAndTime1: '28-Apr-2020',
  dateAndTime: `${todayDate.getDate()}/${todayDate.getMonth()}/${todayDate.getFullYear()}`,
...
@Component({
    selector: 'app-create-sub-head',
    templateUrl: './create-sub-head.component.html',
    styleUrls: ['./create-sub-head.component.css']
})

export class CreateSubHeadComponent implements OnInit, OnDestroy {
  ...
  // Entry Field Details
    ...
    // Add Row
    addDetailHead() {
        if (this.dataSourceDetailHead) {
            const data = this.dataSourceDetailHead.data[this.dataSourceDetailHead.data.length - 1];
            if (true) {
                const p_data = this.dataSourceDetailHead.data;
                p_data.push({
                    detailHeadCode: '',
                    detailHeadDesEng: '',
                    detailHeadDesGuj: '',
                ...
                this.dataSourceDetailHead.data = p_data;
            }
        }
    }

    // Delete Row
    deleteDetailHead(index) {
        this.dataSourceDetailHead.data.splice(index, 1);
        this.dataSourceDetailHead = new MatTableDataSource(this.dataSourceDetailHead.data);
    }
...
@Component({
  selector: 'app-new-sub-head-history',
  templateUrl: './new-sub-head-history.component.html',
  styleUrls: ['./new-sub-head-history.component.css']
})
export class NewSubHeadHistoryComponent implements OnInit {
 ...
 // title: string;
  ...
  historyColumns: string[] = [
    'srNo', 'userCode', 'userSortName', 'userRole', 'designation',
     'detailHeadCode', 'detailHeadDesEng', 'detailHeadDesGuj', 'greenPublication', 'dateAndTime'
  ];

  constructor(public dialogRef: MatDialogRef<NewSubHeadHistoryComponent>,
