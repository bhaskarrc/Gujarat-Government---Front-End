...
@Component({
  selector: 'app-supplementary-demand-list',
  templateUrl: './supplementary-demand-list.component.html',
  styleUrls: ['./supplementary-demand-list.component.css']
})
export class SupplementaryDemandListComponent implements OnInit {
  // Listing table Data
