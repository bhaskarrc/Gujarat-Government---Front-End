...
@Component({
  selector: 'app-supplementary-demand-consolidate-view',
  templateUrl: './supplementary-demand-consolidate-view.component.html',
  styleUrls: ['./supplementary-demand-consolidate-view.component.css']
})
export class SupplementaryDemandConsolidateViewComponent implements OnInit {
  ...
  DATA: SuppDemand[] = [
    ...
    createForm() {
      this.createSupplementaryDemandForm = this.fb.group({
        dept: ['Agriculture & Co-operation Department'],
      });
    }
    // History Popup
    openHistory(data) {
