...
const ELEMENT_DATAR: StandingChargeElementRev[] = [
  {
    objecthead: '3131', thirdlastyear: 200, secondlastyear: 250.00, lastyear: 251, currentyear: 356, last8month: 457,
    first4month: 789, totalof8and4month: 405, col6: '', col7: '', amountproposedbyDDO: 500, hodProposedAmt:200, remarks: '', 
  }
];
...
@Component({
  selector: 'app-standing-charge-edit',
  templateUrl: './standing-charge-edit.component.html',
  styleUrls: ['./standing-charge-edit.component.css']
})
export class StandingChargeEditComponent implements OnInit {
