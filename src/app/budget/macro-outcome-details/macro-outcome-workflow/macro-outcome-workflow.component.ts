...
@Component({
  selector: 'app-macro-outcome-workflow',
  templateUrl: './macro-outcome-workflow.component.html',
  styleUrls: ['./macro-outcome-workflow.component.css']
})
export class MacroOutcomeWorkflowComponent implements OnInit {
  ...
  currentLang = new BehaviorSubject<string>('Eng');
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<MacroOutcomeWorkflowComponent>,
