...
@Component({
  selector: 'app-macro-outcome-history-popup',
  templateUrl: './macro-outcome-history-popup.component.html',
  styleUrls: ['./macro-outcome-history-popup.component.css']
})
export class MacroOutcomeHistoryPopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<MacroOutcomeHistoryPopupComponent>,
