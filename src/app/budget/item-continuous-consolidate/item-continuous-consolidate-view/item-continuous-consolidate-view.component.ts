...
const ELEMENT_DATA2_NEW: any[] = [
  {
      ...
      lastYear: 2018, criteria: '200', endBaseLine: 1.79, improvementFifteen: 100,
      improvementSixteen: 252, improvementEighteen: 253, currentYear: '356.00',
      underStatedOperation: 475, amountProposedByHod: '', remarks: '', toolTipData:
      '0101 : Pay of Officers Including Grade Pay', isBreakup: false
  },
  {
      year: '2010', objectHead: '7058', actualsThirdLastYear: 2019, actualsSecondLastYear: 2018,
      lastYear: 2018, criteria: '200', endBaseLine: 1.79, improvementFifteen: 100,
      improvementSixteen: 252, improvementEighteen: 253, currentYear: '356.00',
      underStatedOperation: 475, amountProposedByHod: '', remarks: '', toolTipData:
      '3131 : Grants-in-Aid General to Panchayats pertaining to pay and allowances', isBreakup: false
  },
];
...
const CSSDetails: any[] = [
  { schemeName: '1.00', actualReciSecondLast: '2.20', actualReciLastYear: '1.00' },
  { schemeName: '2.00', actualReciSecondLast: '6.30', actualReciLastYear: '2.00' },
  { schemeName: '1.20', actualReciSecondLast: '5.40', actualReciLastYear: '0.40' },
  { schemeName: '1.40', actualReciSecondLast: '3.50', actualReciLastYear: '0.20' },
  { schemeName: '1.50', actualReciSecondLast: '1.20', actualReciLastYear: '1.00' },
  { schemeName: '1.60', actualReciSecondLast: '2.10', actualReciLastYear: '0.89' },
];
@Component({
  selector: 'app-item-continuous-consolidate-view',
  templateUrl: './item-continuous-consolidate-view.component.html',
  styleUrls: ['./item-continuous-consolidate-view.component.css']
})
export class ItemContinuousConsolidateViewComponent implements OnInit {animal: string;
  name: string;
...
displayedschemColumnsSection = ['details', 'amount', 'persentage', 'amountscpc', 'persentagescpc', 'amounttasp', 'persentagetasp', 'totalschem'];
