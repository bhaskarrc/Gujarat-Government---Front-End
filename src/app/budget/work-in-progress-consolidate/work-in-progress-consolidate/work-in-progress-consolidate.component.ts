...
@Component({
  selector: 'app-work-in-progress-consolidate',
  templateUrl: './work-in-progress-consolidate.component.html',
  styleUrls: ['./work-in-progress-consolidate.component.css']
})
export class WorkInProgressConsolidateComponent implements OnInit {
