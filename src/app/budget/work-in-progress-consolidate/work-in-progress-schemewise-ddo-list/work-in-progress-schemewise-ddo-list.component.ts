...
// const DDO_NotProposed_List: DDONotProposedList[] = [
//   { checkbox: false, ddoName: 'DDO 14', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 15', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 16', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 17', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 18', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 6', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 7', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 8', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 9', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 10', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 11', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 12', ddoProposedAmt: '-', },
//   { checkbox: false, ddoName: 'DDO 13', ddoProposedAmt: '-', },
// ];

@Component({
  selector: 'app-work-in-progress-schemewise-ddo-list',
  templateUrl: './work-in-progress-schemewise-ddo-list.component.html',
  styleUrls: ['./work-in-progress-schemewise-ddo-list.component.css']
})
export class WorkInProgressSchemewiseDdoListComponent implements OnInit {
...
// ddoNotProposedListColumn: string[] = ['srNo', 'checkbox', 'ddoName', 'ddoProposedAmt', 'action'];
// ddoNotProposedListColumn: string[] = ['srNo', 'checkbox', 'ddoName', 'ddoProposedAmt'];
...
loadDetailView (data) {
  this.router.navigate(['/budget/work-in-progress-view', {percentage: this.percentage, amount:this.amount}]);
