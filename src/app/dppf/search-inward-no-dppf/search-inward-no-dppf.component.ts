...
@Component({
  selector: 'app-search-inward-no-dppf',
  templateUrl: './search-inward-no-dppf.component.html',
  styleUrls: ['./search-inward-no-dppf.component.css']
})
export class SearchInwardNoDppfComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<SearchInwardNoDppfComponent>, private fb: FormBuilder) { }
