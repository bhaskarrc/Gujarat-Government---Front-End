...
@Component({
  selector: 'app-inward-outward-letter-screen-list',
  templateUrl: './inward-outward-letter-screen-list.component.html',
  styleUrls: ['./inward-outward-letter-screen-list.component.css']
})
export class InwardOutwardLetterScreenListComponent implements OnInit {
  // Variable
  errorMessage;
  inwardtype = 'Letter';
  // Form Group
  inwardOutwardBranchForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.inwardOutwardBranchForm = this.fb.group({
      inwardNumber: [''],
      inwardFDate: [''],
      letterNumber: [''],
  ...
  goToSavedBillList() { }
  clearForm() {
    this.inwardOutwardBranchForm.reset();
  }
  ...
  openInwardNoDialog() {
    if (this.inwardOutwardBranchForm.controls.inward.value === '1') {
      this.router.navigate(['./dppf/inward-outward-letter-screen']);
      this.dataService.setOption('fromInwardList', 'Letter');
    } else if (this.inwardOutwardBranchForm.controls.inward.value === '2') {
      this.router.navigate(['./dppf/inward-outward-letter-screen']);
      this.dataService.setOption('fromInwardList', 'RTI');
    } else {
      this.router.navigate(['./dppf/inward-outward-letter-screen']);
      this.dataService.setOption('fromInwardList', 'Letter');
    }
