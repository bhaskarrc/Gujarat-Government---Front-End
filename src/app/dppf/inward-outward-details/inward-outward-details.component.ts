...
import { FamilyDetails, ServiceBreakDetail, ServiceOtherDetail, PensionDetails, RecoveryDetail } from 'src/app/model/dppf';
...
@Component({
  selector: 'app-inward-outward-details',
  templateUrl: './inward-outward-details.component.html',
  styleUrls: ['./inward-outward-details.component.css']
})
export class InwardOutwardDetailsComponent implements OnInit {
  // Table Sourece
  ...
  pensionCutDataSource = new MatTableDataSource<any>(
    this.pensionCutData
  );
