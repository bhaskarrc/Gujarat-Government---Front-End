...
import { FamilyMember, PensionToFromDate, FamilyDetail } from 'src/app/model/dppf';

@Component({
  selector: 'app-dppf-online-pension-case-print',
  templateUrl: './dppf-online-pension-case-print.component.html',
  styleUrls: ['./dppf-online-pension-case-print.component.css']
})
export class DppfOnlinePensionCasePrintComponent implements OnInit {
  // Date
  todayDate = new Date();
  ...
  educationOrderDate = this.todayDate; nomineDateOfBirth = this.todayDate;
