...
@Component({
    selector: 'app-workflow-details-dppf',
    templateUrl: './workflow-details-dppf.component.html',
    styleUrls: ['./workflow-details-dppf.component.css']
})
export class WorkflowDetailsDppfComponent implements OnInit {
    ...
    headerJso: HeaderElement[] = [
        { label: 'Employee No.', value: '1000000001' },
        { label: 'Name', value: 'Amitbhai Patel' },
        { label: 'Type of Pension', value: 'Superannuation' },
        { label: 'Pension Case Type', value: 'New' },
        { label: 'Type of Inward', value: 'Pension Case' },
        { label: 'Office Name', value: 'Director of Account and Treasury' },
        { label: 'Designation', value: 'Senior Clerk' },
        { label: 'Date of Joining', value: '15-Feb-1986' },
        { label: 'Date of Retirement', value: '30-Jun-2026' },
    ];
    ...
    forwardDialog_history_list: any[] = [
        { id: 1, userName: 'Shri A P Patel', designation: 'Auditor', date: '1/11/2019', comment: 'Pension Case' },
        { id: 2, userName: 'Shri M K Makawana', designation: 'Junior Clerk', date: '10/11/2019', comment: 'We may approve' },
        { id: 3, userName: 'Shri S D Patel', designation: 'Junior Clerk', date: '11/11/2019', comment: 'We may approve' },
    ...
    branch_list: ListValue[] = [
        { value: '1', viewValue: 'Branch Name' },
        { value: '2', viewValue: 'Branch Name 1' },
        { value: '3', viewValue: 'Branch Name 2' },
    ];

    filteredBranchName: ListValue[] = [
        { value: '1', viewValue: 'PR-1' },
        { value: '2', viewValue: 'PR-2' },
        { value: '3', viewValue: 'PR-3' },
        { value: '1', viewValue: 'PR-4' },
        { value: '2', viewValue: 'PR-5' },
        { value: '3', viewValue: 'PR-6' },
        { value: '1', viewValue: 'PR-7' },
        { value: '2', viewValue: 'PR-8' },
    ];
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsDppfComponent>,
