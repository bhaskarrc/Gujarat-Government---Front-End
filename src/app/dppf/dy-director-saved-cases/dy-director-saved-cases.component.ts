...
@Component({
  selector: 'app-dy-director-saved-cases',
  templateUrl: './dy-director-saved-cases.component.html',
  styleUrls: ['./dy-director-saved-cases.component.css']
})
export class DyDirectorSavedCasesComponent implements OnInit {
  // Variabledy-director-listing
  refNuberDate: any;
  // Date
  todayDate = new Date();
  // Table Source
