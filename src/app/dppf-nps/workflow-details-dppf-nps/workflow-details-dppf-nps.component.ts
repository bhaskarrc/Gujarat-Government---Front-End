...
@Component({
    selector: 'app-workflow-details-dppf-nps',
    templateUrl: './workflow-details-dppf-nps.component.html',
    styleUrls: ['./workflow-details-dppf-nps.component.css']
})
export class WorkflowDetailsDppfNpsComponent implements OnInit {
    ...
    headerJso: HeaderElement[] = [
        { label: 'Employee Number', value: '2014528563' },
        { label: 'Name:', value: 'Karsandas J Patel' },
        { label: 'Office Name', value: 'Director of Pension and Providudend fund' },
        { label: 'Department', value: 'Finanace Department' },
        { label: 'Head of Department', value: 'DPPF - Pension' },
        { label: 'PPA No.', value: '' },
        { label: 'PRAN No.', value: '' },
    ];
    ...
    forwardDialog_history_list: any[] = [
        ...
        { id: 1, userName: 'Shri S M Modi', designation: 'Deputy Section Officer', role: 'Creator', date: '1/11/2019', comment: 'We may Approve' },
        // tslint:disable-next-line: max-line-length
    ...
    user_list: ListValue[] = [
        { value: '1', viewValue: 'Ramanbhai Shah (NPS)' },
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsDppfNpsComponent>,
