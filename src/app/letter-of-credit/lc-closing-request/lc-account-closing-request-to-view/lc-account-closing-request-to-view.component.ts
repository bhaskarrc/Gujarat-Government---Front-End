...
@Component({
  selector: 'app-lc-account-closing-request-to-view',
  templateUrl: './lc-account-closing-request-to-view.component.html',
  styleUrls: ['./lc-account-closing-request-to-view.component.css']
})
export class LcAccountClosingRequestToViewComponent implements OnInit {
