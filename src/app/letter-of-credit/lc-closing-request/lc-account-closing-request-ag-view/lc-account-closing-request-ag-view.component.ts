...
@Component({
  selector: 'app-lc-account-closing-request-ag-view',
  templateUrl: './lc-account-closing-request-ag-view.component.html',
  styleUrls: ['./lc-account-closing-request-ag-view.component.css']
})
export class LcAccountClosingRequestAgViewComponent implements OnInit {
