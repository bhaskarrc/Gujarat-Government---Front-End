...
@Component({
  selector: 'app-lc-distribution-edit',
  templateUrl: './lc-distribution-edit.component.html',
  styleUrls: ['./lc-distribution-edit.component.css']
})
export class LcDistributionEditComponent implements OnInit {
  ...
  LcdistributionInputDATAColumn: string[] = [
    'select', 'srno', 'classOfExpenditure', 'fundType', 'budgetType', 'demandNo', 'majorHead', 'subMajorHead', 'minorHead', 'subHead', 'detailHead', 'TypeOfEstimate', 'itemName', 'objectHead',
    'schemeNo', 'amount'
  ];
