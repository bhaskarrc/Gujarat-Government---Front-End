...
@Component({
  selector: 'app-lc-authorization-to-edit',
  templateUrl: './lc-authorization-to-edit.component.html',
  styleUrls: ['./lc-authorization-to-edit.component.css']
})
export class LcAuthorizationToEditComponent implements OnInit {
