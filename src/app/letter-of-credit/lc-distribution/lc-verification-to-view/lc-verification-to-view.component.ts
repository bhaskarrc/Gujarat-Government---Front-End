...
@Component({
  selector: 'app-lc-verification-to-view',
  templateUrl: './lc-verification-to-view.component.html',
  styleUrls: ['./lc-verification-to-view.component.css']
})
export class LcVerificationToViewComponent implements OnInit {
  ...
  LcdistributionInputDATAColumn: string[] = [
    'srno', 'fundType', 'classOfExpenditure', 'budgetType', 'demandNo',
     'majorHead', 'subMajorHead', 'minorHead', 'subHead', 'detailHead', 'TypeOfEstimate', 'itemName', 'objectHead',
    'schemeNo', 'amount'
  ];
