...
@Component({
  selector: 'app-lc-distribution-circle-view',
  templateUrl: './lc-distribution-circle-view.component.html',
  styleUrls: ['./lc-distribution-circle-view.component.css']
})
export class LcDistributionCircleViewComponent implements OnInit {
