...
@Component({
  selector: 'app-lc-opening-request-to-view',
  templateUrl: './lc-opening-request-to-view.component.html',
  styleUrls: ['./lc-opening-request-to-view.component.css']
})
export class LcOpeningRequestToViewComponent implements OnInit {
