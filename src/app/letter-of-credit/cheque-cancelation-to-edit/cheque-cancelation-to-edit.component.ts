...
@Component({
  selector: 'app-cheque-cancelation-to-edit',
  templateUrl: './cheque-cancelation-to-edit.component.html',
  styleUrls: ['./cheque-cancelation-to-edit.component.css']
})
export class ChequeCancelationToEditComponent implements OnInit {
