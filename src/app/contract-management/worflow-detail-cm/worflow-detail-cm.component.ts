...
@Component({
  selector: 'app-worflow-detail-cm',
  templateUrl: './worflow-detail-cm.component.html',
  styleUrls: ['./worflow-detail-cm.component.css']
})

export class WorflowDetailCMComponent implements OnInit {
  ...
  public showData = true;
   ...
   constructor(
       ...
       public dialogRef: MatDialogRef<WorflowDetailCMComponent>,
