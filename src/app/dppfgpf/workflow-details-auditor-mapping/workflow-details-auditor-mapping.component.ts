...
@Component({
    selector: 'app-workflow-details-auditor-mapping',
    templateUrl: './workflow-details-auditor-mapping.component.html',
    styleUrls: ['./workflow-details-auditor-mapping.component.css']
})
export class WorkflowDetailsAuditorMappingComponent implements OnInit {
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsAuditorMappingComponent>,
