...
import { PayRegistrySearchList, DialogData } from 'src/app/model/pvu-registry';
import { Observable, Subject } from 'rxjs';
import { startWith, map } from 'rxjs/operators';
import { CommonListing } from 'src/app/model/common-listing';

@Component({
    selector: 'app-pvu-registry',
    templateUrl: './pvu-registry.component.html',
    styleUrls: ['./pvu-registry.component.css']
})
export class PvuRegistryComponent implements OnInit {

    ELEMENT_DATA: PayRegistrySearchList[] = [
        {
            checkbox: false, transNo: 1002, inwardDate: '-', inwardNo: '-', eventName: 'Change of Scale', empNumber: 1100100012,
            employeeName: 'Narendra', empDesignation: 'Assistant Manager', retirementDate: '10/10/2019',
            empType: 'Regular', fwdDate: '10/10/2019',  officeName: 'Pension Payment Office, Ahmedabad'
        },
        {
            checkbox: false, transNo: 1003, inwardDate: '-', inwardNo: '-', eventName: 'Senior Scale', empNumber: 1100100020,
            employeeName: 'Pankaj', empDesignation: 'Dy. Manager', retirementDate: '10/10/2019',
            empType: 'Regular', fwdDate: '10/10/2019', officeName: 'District Treasury Office, Ahmedabad'
        },
        {
            checkbox: false, transNo: 1004, inwardDate: '-', inwardNo: '-', eventName: 'Change of Scale', empNumber: 1100102000,
            employeeName: 'Amit', empDesignation: 'Manager', retirementDate: '10/10/2019',
            empType: 'Regular', fwdDate: '10/10/2019', officeName: 'Pay & Accounts Office Ahmedabad'
        },
    ];
    ...
    fwdInwardData(): void {
        ...
        const dialogRef = this.dialog.open(FwdPvuRegistryDialogComponent, {
            width: '400px',
            data: selectedData
        });
...
@Component({
    selector: 'app-pvu-registry-dialog',
    templateUrl: 'pvu-registry-dialog.html',
})
export class FwdPvuRegistryDialogComponent implements OnInit {
    ...
    constructor(
        private fb: FormBuilder,
        public dialogRef: MatDialogRef<FwdPvuRegistryDialogComponent>,
