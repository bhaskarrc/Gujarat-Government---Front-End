...
@Component({
    selector: 'app-pvu-events',
    templateUrl: './pvu-events.component.html',
    styleUrls: ['./pvu-events.component.css']
})
export class PvuEventsComponent implements OnInit {
    ...
    eventList_list: CommonList[] = [
        { id: '1', name: 'Higher Pay Scale' },
        { id: '2', name: 'Assured Career Progression' },
        { id: '3', name: 'Career Advancement Scheme' },
        { id: '4', name: 'Tiku Pay' },
        { id: '5', name: 'Shetty Pay' },
        { id: '5', name: 'Senior Scale' },
        { id: '5', name: 'Selection Grade' },
        { id: '5', name: 'Stepping Up' },
    ];
    ...
    dataSpurcecccExams = new MatTableDataSource<CCCEXAM>(this.cccExam);
    displayedColumnsccExams = ['examName', 'examBody', 'dateOfPassing', 'status'];

    dataSourcedepartMentExams = new MatTableDataSource<DEPARTMENTEXAM>(this.departmental);
    displayedDeptColumns = ['examName', 'examBody', 'dateOfPassing', 'status'];

    dataSourceLangExams = new MatTableDataSource<LANGUAGEEXAM>(this.languageExam);
