...
@Component({
  selector: 'app-report-gtr-fourty-four',
  templateUrl: './report-gtr-fourty-four.component.html',
  styleUrls: ['./report-gtr-fourty-four.component.css']
})
export class ReportGtrFourtyFourComponent implements OnInit {
