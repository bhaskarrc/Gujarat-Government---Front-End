...
import { RejectedBillsByTo } from 'src/app/model/ddo-forms';

@Component({
  selector: 'app-rejected-by-to',
  templateUrl: './rejected-by-to.component.html',
  styleUrls: ['./rejected-by-to.component.css']
})
export class RejectedByToComponent implements OnInit {
  ...
  elementData: RejectedBillsByTo[] = [
    {
      ...
      billStatus: 'Approved', typeBill: 'Regular Bill', tokenno: '11', grossAmount: '123.22',
    },

    {
      ...
      ddoName: 'District Treasury Officer,DISTRICT TREASURY OFFICE, Gandhinagar ',
      billStatus: 'Created', typeBill: 'Regular Bill', tokenno: '112', grossAmount: '123.22',
    },

    {
      ...
      ddoName: 'District Treasury Officer,DISTRICT TREASURY OFFICE, Gandhinagar ',
      billStatus: 'Created', typeBill: 'Regular Bill', tokenno: '31', grossAmount: '123.22',
    },

    {
      ...
      ddoName: 'District Treasury Officer,DISTRICT TREASURY OFFICE, Gandhinagar ',
      billStatus: 'Created', typeBill: 'Regular Bill', tokenno: '51', grossAmount: '123.22',
    },

    {
      ...
      majorHead: '8009', billNetValue: '100.00', ddoNo: '416',
      ddoName: 'District Treasury Officer,DISTRICT TREASURY OFFICE, Gandhinagar ',
      billStatus: 'Created', typeBill: 'Regular Bill', tokenno: '61', grossAmount: '123.22',
    },

  ];
  dataSource = new MatTableDataSource<RejectedBillsByTo>(this.elementData);
