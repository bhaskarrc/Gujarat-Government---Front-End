...
export class SavedBillComponent implements OnInit {
  ...
  // directive checkbox for workflow
  ...
  elementData: SavedBill[] = [
    {
      ...
      ddoName: 'District Treasury Officer,DISTRICT TREASURY OFFICE, Gandhinagar ', billStatus: 'Approved', typeBill: 'Regular Bill'
    },

    {
      ...
      ddoName: 'District Treasury Officer,DISTRICT TREASURY OFFICE, Gandhinagar ', billStatus: 'Created', typeBill: 'Regular Bill'
    },
  ...
  dataSource = new MatTableDataSource<SavedBill>(this.elementData);
