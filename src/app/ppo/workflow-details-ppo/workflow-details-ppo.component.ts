...
@Component({
    selector: 'app-workflow-details-ppo',
    templateUrl: './workflow-details-ppo.component.html',
    styleUrls: ['./workflow-details-ppo.component.css']
})
export class WorkflowDetailsPpoComponent implements OnInit {
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsPpoComponent>,
