...
@Component({
  selector: 'app-counter-allocation-inward-pension',
  templateUrl: './counter-allocation-inward-pension.component.html',
  styleUrls: ['./counter-allocation-inward-pension.component.css']
})
export class CounterAllocationInwardPensionComponent implements OnInit {
  // variables
  todayDate = new Date();
  isShown = false;
