...
@Component({
  selector: 'app-stamp-register-listing',
  templateUrl: './stamp-register-listing.component.html',
  styleUrls: ['./stamp-register-listing.component.css']
})
export class StampRegisterListingComponent implements OnInit {
  ...
  elementData: StampRegisterReportListing[] = [
    ...
    },
    {
      ...
      utilizationAmountOfTickets: '500.00', closingBalance: '9800.00', remarks: '', status: 'Pending From Verifier'
    },
    {
      date: '15-May-2019', openingBalance: '9800.00', amtOfReceivedTickets: '0.00', totalAmtOfTickets: '9800.00',
      utilizationAmountOfTickets: '800.00', closingBalance: '9000.00', remarks: '', status: 'Verify'
    },
  ];
  ...
  displayedColumns: string[] = ['position', 'date', 'openingBalance', 'amtOfReceivedTickets', 'totalAmtOfTickets',
    'utilizationAmountOfTickets', 'closingBalance', 'remarks', 'status', 'action'];
