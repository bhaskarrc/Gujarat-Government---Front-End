...
import { LrParaListing } from 'src/app/model/local-fund';




@Component({
  selector: 'app-lr-para-listing',
  templateUrl: './lr-para-listing.component.html',
  styleUrls: ['./lr-para-listing.component.css']
})
export class LrParaListingComponent implements OnInit {

  // variable
  referenceNumber = 'Reference Number:';
  referenceNumberDate = 'Reference Date:';
  filterElementData: LrParaListing[];
  // date
  todayDate = Date.now();
  // form group
  ...
  dataSource = new MatTableDataSource<LrParaListing>(this.elementData);
  ...
  onSearch() {
    ...
    if (formVal.instituteType !== '' && formVal.instituteType != null) {
      ...
      this.dataSource = new MatTableDataSource<LrParaListing>(this.filterElementData);
    ...
    if (
      ...
      this.dataSource = new MatTableDataSource<LrParaListing>(this.elementData);
    }
