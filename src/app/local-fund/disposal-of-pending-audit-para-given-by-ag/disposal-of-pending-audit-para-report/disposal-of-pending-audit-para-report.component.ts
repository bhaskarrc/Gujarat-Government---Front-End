...
@Component({
  selector: 'app-disposal-of-pending-audit-para-report',
  templateUrl: './disposal-of-pending-audit-para-report.component.html',
  styleUrls: ['./disposal-of-pending-audit-para-report.component.css']
})
export class DisposalOfPendingAuditParaReportComponent implements OnInit {
  ...
  instituteNameList: ListValue[] = [
    { value: '0', viewValue: 'Ahmedabad District Panchayat' },
  ...
  onSearch() {
    ...
    if (formVal.instituteType !== '' && formVal.instituteType != null) {
      ...
      if (formVal.instituteType === '11') {
        ...
        this.dataSource = new MatTableDataSource<DisposalOfPendingAuditPara>(this.filterElementData);
      } else {
