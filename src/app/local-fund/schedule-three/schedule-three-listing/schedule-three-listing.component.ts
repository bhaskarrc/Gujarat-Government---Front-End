...
@Component({
  selector: 'app-schedule-three-listing',
  templateUrl: './schedule-three-listing.component.html',
  styleUrls: ['./schedule-three-listing.component.css']
})
export class ScheduleThreeListingComponent implements OnInit {

  searchForm: FormGroup;
  filterElementData: any[];
  talukaPanchayatAllotmentValue = 1295000;
  receivedStatutaryGrant = 0;
  selection = new SelectionModel<ScheduleThree>(true, []);
