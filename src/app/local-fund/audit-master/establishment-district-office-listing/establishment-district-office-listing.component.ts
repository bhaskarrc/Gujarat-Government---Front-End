...
@Component({
  selector: 'app-establishment-district-office-listing',
  templateUrl: './establishment-district-office-listing.component.html',
  styleUrls: ['./establishment-district-office-listing.component.css']
})
export class EstablishmentDistrictOfficeListingComponent implements OnInit {
