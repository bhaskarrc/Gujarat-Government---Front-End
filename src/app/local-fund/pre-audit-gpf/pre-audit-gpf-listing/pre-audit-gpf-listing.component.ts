...
@Component({
  selector: 'app-pre-audit-gpf-listing',
  templateUrl: './pre-audit-gpf-listing.component.html',
  styleUrls: ['./pre-audit-gpf-listing.component.css']
})
export class PreAuditGpfListingComponent implements OnInit {
  ...
  Element_Data: PreAuditGpfListing[] = [
    ...
    },
    {
      ...
      doj: '12-Jul-1956', dor: '12-Apr-1977', retirementType: 'Expired', status: 'Verified'
    },
    {
  ...
  displayedColumns: any[] = ['position', 'instituteType', 'instituteName', 'employeeNo', 'employeeName',
    'designation', 'accNo', 'doj', 'dor', 'retirementType', 'status', 'action'];
