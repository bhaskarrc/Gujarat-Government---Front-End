...
import { ScheduleFiveReport } from 'src/app/model/local-fund';

@Component({
  selector: 'app-schedule-five-report',
  templateUrl: './schedule-five-report.component.html',
  styleUrls: ['./schedule-five-report.component.css']
})
export class ScheduleFiveReportComponent implements OnInit {
  ...
  // listing data
  ElementData: ScheduleFiveReport[] = [
    {
  ...
  // listing datasource
  dataSource = new MatTableDataSource<ScheduleFiveReport>(this.ElementData);
