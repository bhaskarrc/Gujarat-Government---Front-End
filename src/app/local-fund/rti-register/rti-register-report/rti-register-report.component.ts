...
@Component({
  selector: 'app-rti-register-report',
  templateUrl: './rti-register-report.component.html',
  styleUrls: ['./rti-register-report.component.css']
})
export class RtiRegisterReportComponent implements OnInit {
  ...
  displayedColumns: any[] = ['position', 'applicationNo', 'applicationDate', 'applicantNameAndAddress',
