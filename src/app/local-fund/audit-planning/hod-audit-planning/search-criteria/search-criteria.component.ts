...
export class SearchCriteriaComponent implements OnInit {
  ...
  instituteNameList: ListValue[] = [
    ...
    { value: '3', viewValue: 'District Panchayat Gandhinagar' },
  ];
  ...
  elementData: any[] = [{
    ...
    taluka1: 'Ahmedabad',
    village1: 'Ahmedabad',
    instituteType1: 'District Panchayat',
    instituteName1: 'Ahmedabad District Panchayat',
    auditStartDate1: '20-Aug-2018',
    auditEndDate1: '20-Oct-2018',
    proposedAuditUnit1: '35',
    suggestedAuditUnit1: '20',
    total1: '55',
  },
  {
    auditYear1: '2018-19',
    ...
    taluka1: 'Balva',
    village1: 'Adroda',
    instituteType1: 'Village Panchayat',
    instituteName1: 'Adroda District Panchayat',
    auditStartDate1: '14-Jun-2018',
    auditEndDate1: '15-Jul-2018',
