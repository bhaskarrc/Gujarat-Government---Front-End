...
import { ScheduleFour } from 'src/app/model/local-fund';



@Component({
  selector: 'app-schedule-four-listing',
  templateUrl: './schedule-four-listing.component.html',
  styleUrls: ['./schedule-four-listing.component.css']
})
export class ScheduleFourListingComponent implements OnInit {

  searchForm: FormGroup;
  filterElementData: any[];
  selection = new SelectionModel<ScheduleFour>(true, []);
  ...
  dataSource = new MatTableDataSource<ScheduleFour>(this.ElementData);
  ...
  // search on basis of search fields
  onSearch() {
