...
import {
    ...
    NomineeData, DeptExamData, SpclExamData, LanguageExamDataPao, DialogData
...
export class EmployeeCreationComponent implements OnInit {
    ...
    displayedEventsColumns: string[] = ['position', 'empNumber', 'empName', 'caseNo',
        'empPayBand', 'empPayLevel', 'empBasicPay', 'dateOfNextIncrement', 'empDesignation', 'optionOpted', 'dateOfAudit', 'action'];
    ...
    curOffice_list: CommonListing[] = [
        { value: '1', viewValue: 'Finance Department' },
        { value: '2', viewValue: 'RNB Department' },
    ];

    cadre_list: CommonListing[] = [
        { value: '1', viewValue: 'IAS' },
        { value: '2', viewValue: 'IPF' },
        { value: '3', viewValue: 'IFS' },
        { value: '4', viewValue: 'Deputation from Other Cadre' },
    ];
    ...
    deputDept_list: CommonListing[] = [
        { value: '1', viewValue: 'Ministry of External Affairs' },
    ...
    currentOfficeCtrl: FormControl = new FormControl();
    ...
    deputDeptCtrl: FormControl = new FormControl();
    ...
    languageExamData: LanguageExamDataPao[] = [
        {
            langName: '', examBody: '', examType: '', dateOfPassing: '', seatNo: '', examStatus: '', remarks: '', notificationNo: ''
        }
    ];
    displayedLangExamColumns = ['langName', 'examBody', 'examType', 'dateOfPassing', 'seatNo', 'examStatus',
        'remarks', 'notificationNo', 'Action'];
    dataSourceLangExam = new MatTableDataSource<LanguageExamDataPao>(this.languageExamData);
    maxDate = new Date();
    ...
    createForm() {
        ...
        this.departmentalDetails = this.fb.group({
            ...
            notificationNo: ['', Validators.required],
            deputDept: ['', Validators.required],
            ...
            payLevelMetrixName: ['', Validators.required],
