...
@Component({
    selector: 'app-workflow-details-grant',
    templateUrl: './workflow-details-grant-pao.component.html',
    styleUrls: ['./workflow-details-grant-pao.component.css']
})
export class WorkflowDetailsGrantPaoComponent implements OnInit {
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsGrantPaoComponent>,
