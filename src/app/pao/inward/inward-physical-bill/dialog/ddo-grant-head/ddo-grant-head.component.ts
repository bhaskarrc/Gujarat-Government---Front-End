...
export class DdoGrantHeadInwardComponent {
    ...
    constructor(public dialogRef: MatDialogRef<DdoGrantHeadInwardComponent>, @Inject(MAT_DIALOG_DATA) public data: DialogData, ) { }
