...
export class CardexnoPaoComponent implements OnInit {
  ...
  constructor(private router: Router,public dialog: MatDialog,private fb: FormBuilder, public dialogRef: MatDialogRef<CardexnoPaoComponent>,) { }
