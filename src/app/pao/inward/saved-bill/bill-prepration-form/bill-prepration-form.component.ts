...
// import { WorkflowDetailsGrantComponent } from 'src/app/pao/workflow-details-grant/workflow-details-grant.component';
...
export class BillPreprationFormComponent implements OnInit {
  ...
  receiptList: any[] = [
    {
      edpCode: '9510', description: 'Income Tax', dedType: 'A',
      majorHead: '8658', subMajorHead: '00', minerHead: '112', subHead: '00',
      amount: '100.00'
    },
    {
      edpCode: '9520', description: 'Surcharge On Income Tax', dedType: 'A', majorHead: '8658',
      subMajorHead: '00', minerHead: '112', subHead: '00', amount: '400.00'
    },
    {
      edpCode: '9600', description: 'Security Deposit', dedType: 'A', majorHead: '8443',
      subMajorHead: '00', minerHead: '103', subHead: '00', amount: '500.00'
    },
  ...
  attachment_data: any[] = [
    { fileName: 'Sample Image', fileType: 'image', filePath: 'assets/img/img-pdf.PNG', imgStatus: false },
  ]
...
//   constructor(
//     public dialogRef: MatDialogRef<GTR44Dialog>,
...
//     'remarks'
//   ];
//   IncomeTaxDetail = new MatTableDataSource(INCOMETAX_DATA);
...
//     'remarks'
//   ];
//   IncomeTaxDetail = new MatTableDataSource(INCOMETAX_DETAILS_DATA);

//   onNoClick(): void {
//     this.dialogRef.close();
//   }
// }
/* END OF CHECK LIST OPPUP */
