...
import { DDOLEVEL } from 'src/app/model/treasury-bill';
...
export class DdoLevelComponent implements OnInit {
  ...
  openDialog() {
    ...
    const dialogRef = this.dialog.open(siignaturedialogPaoComponent, {
      width: 'auto',
    });
...
export class siignaturedialogPaoComponent {
  constructor(
    private router: Router,
    public dialogRef: MatDialogRef<siignaturedialogPaoComponent>
  ) { }
