...
import { AcceptanceCriteriaComponent } from '../audit-bills-auditor/acceptance-criteria/acceptance-criteria.component';
...
export class InwardPhysicalBillAuditLevelComponent implements OnInit {
  ...
  auditorNameList: ListValue[] = [{ value: '1', viewValue: 'Shri Pratik K Shah' }];
