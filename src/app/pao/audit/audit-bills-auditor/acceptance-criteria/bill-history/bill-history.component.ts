...
export class BillHistoryPaoBillComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef < BillHistoryPaoBillComponent > , private fb: FormBuilder, ) {}
