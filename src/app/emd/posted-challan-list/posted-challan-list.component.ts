...
@Component({
  selector: 'app-posted-challan-list',
  templateUrl: './posted-challan-list.component.html',
  styleUrls: ['./posted-challan-list.component.css']
})
export class PostedChallanListComponent implements OnInit {
  // FormGroup
