...
@Component({
  selector: 'app-posted-challan-list-view',
  templateUrl: './posted-challan-list-view.component.html',
  styleUrls: ['./posted-challan-list-view.component.css']
})
export class PostedChallanListViewComponent implements OnInit {
  checkedVal = false;
  // FormGroup
