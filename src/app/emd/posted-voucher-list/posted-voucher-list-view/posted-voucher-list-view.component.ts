...
@Component({
  selector: 'app-posted-voucher-list-view',
  templateUrl: './posted-voucher-list-view.component.html',
  styleUrls: ['./posted-voucher-list-view.component.css']
})
export class PostedVoucherListViewComponent implements OnInit {

  // FormGroup
  postedVoucherListViewForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.postedVoucherListViewForm = this.fb.group({
      // FormGroup Fields
