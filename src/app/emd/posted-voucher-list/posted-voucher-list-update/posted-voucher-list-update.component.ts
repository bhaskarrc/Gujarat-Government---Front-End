...
@Component({
  selector: 'app-posted-voucher-list-update',
  templateUrl: './posted-voucher-list-update.component.html',
  styleUrls: ['./posted-voucher-list-update.component.css']
})
export class PostedVoucherListUpdateComponent implements OnInit {
