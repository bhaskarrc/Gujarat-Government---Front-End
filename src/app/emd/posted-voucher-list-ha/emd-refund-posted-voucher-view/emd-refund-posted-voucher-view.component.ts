...
@Component({
  selector: 'app-emd-refund-posted-voucher-view',
  templateUrl: './emd-refund-posted-voucher-view.component.html',
  styleUrls: ['./emd-refund-posted-voucher-view.component.css']
})
export class EmdRefundPostedVoucherViewComponent implements OnInit {
