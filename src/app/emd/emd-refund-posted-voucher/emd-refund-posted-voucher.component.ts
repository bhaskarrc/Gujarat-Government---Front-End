...
@Component({
  selector: 'app-emd-refund-posted-voucher',
  templateUrl: './emd-refund-posted-voucher.component.html',
  styleUrls: ['./emd-refund-posted-voucher.component.css']
})
export class EmdRefundPostedVoucherComponent implements OnInit {
  // FormGroup
  emdPostedVoucherForm: FormGroup;
  // dates
  maxDate = new Date();
  date = new Date();
  ...
  ngOnInit() {
    ...
    this.emdPostedVoucherForm = this.fb.group({
      // FormGroup Fields
