...
@Component({
  selector: 'app-posted-challan-list-ha-view',
  templateUrl: './posted-challan-list-ha-view.component.html',
  styleUrls: ['./posted-challan-list-ha-view.component.css']
})
export class PostedChallanListHAViewComponent implements OnInit {
  // variables
  checkedVal = false;
  checked1 = false;
  isSubmitted = false;
  ...
  ngOnInit() {
    this.challanPostingViewForm = this.fb.group({
      ...
      codeDescription: ['Revenue Deposits'],
      majorHead: ['8443'],
      ...
      subHead: ['01'],
      subHeadDecscription: ['Revenue Deposit'],
      srNo: ['192000001 '],
