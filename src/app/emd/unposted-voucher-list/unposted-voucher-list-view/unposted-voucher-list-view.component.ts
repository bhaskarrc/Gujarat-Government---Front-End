...
@Component({
  selector: 'app-unposted-voucher-list-view',
  templateUrl: './unposted-voucher-list-view.component.html',
  styleUrls: ['./unposted-voucher-list-view.component.css']
})
export class UnpostedVoucherListViewComponent implements OnInit {

  // FormGroup
  unpostedVoucherAViewForm: FormGroup;
  // dates
  ...
  ngOnInit() {
    ...
    this.unpostedVoucherAViewForm = this.fb.group({
      // FormGroup Fields
