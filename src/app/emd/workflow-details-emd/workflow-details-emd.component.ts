...
@Component({
    selector: 'app-workflow-details-emd',
    templateUrl: './workflow-details-emd.component.html',
    styleUrls: ['./workflow-details-emd.component.css']
})
export class WorkflowDetailsEmdComponent implements OnInit {
    ...
    headerJso: HeaderElement[] = [
        ...
        { label: 'Code', value: 'TD' },
        { label: 'Major Head', value: '8443' },
        { label: 'Sub Major Head', value: '00' },
        { label: 'Minor Head', value: '101' },
        { label: 'Office Name', value: 'Mr. S. S. Kumar' },
        { label: 'Department', value: 'Legal Department' },
    ...
    forwardDialog_history_list: any[] = [
        ...
        {
            id: 3, userName: 'Shri P M Shah', designation: 'Deputy Secretaryr', role: 'Approver',
            date: '11/11/2019', comment: 'We may approve'
        },
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<WorkflowDetailsEmdComponent>,
    ...
    // function to add row into Attatchment table
    addBrowse() {
