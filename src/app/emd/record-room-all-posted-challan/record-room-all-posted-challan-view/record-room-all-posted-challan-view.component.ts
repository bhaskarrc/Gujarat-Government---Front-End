...
@Component({
  selector: 'app-record-room-all-posted-challan-view',
  templateUrl: './record-room-all-posted-challan-view.component.html',
  styleUrls: ['./record-room-all-posted-challan-view.component.css']
})
export class RecordRoomAllPostedChallanViewComponent implements OnInit {
  checkedVal = false;
  // Dates
  maxDate = new Date();
  date = new Date();
  ...
  ngOnInit() {
    this.recordRoomViewForm = this.fb.group({
      // FormGroup Fields
      subTLocation: [''],
      subTLocation1: ['1'],
      type: ['1'],
