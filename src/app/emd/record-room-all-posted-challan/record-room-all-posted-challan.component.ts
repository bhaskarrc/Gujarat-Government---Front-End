...
@Component({
  selector: 'app-record-room-all-posted-challan',
  templateUrl: './record-room-all-posted-challan.component.html',
  styleUrls: ['./record-room-all-posted-challan.component.css']
})
export class RecordRoomAllPostedChallanComponent implements OnInit {
  // FormGroup
