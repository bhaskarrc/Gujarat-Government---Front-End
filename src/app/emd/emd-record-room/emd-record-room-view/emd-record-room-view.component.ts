...
@Component({
  selector: 'app-emd-record-room-view',
  templateUrl: './emd-record-room-view.component.html',
  styleUrls: ['./emd-record-room-view.component.css']
})
export class EmdRecordRoomViewComponent implements OnInit {
