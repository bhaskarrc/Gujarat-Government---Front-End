...
@Component({
  selector: 'app-emd-challan-posting-view',
  templateUrl: './emd-challan-posting-view.component.html',
  styleUrls: ['./emd-challan-posting-view.component.css']
})
export class EmdChallanPostingViewComponent implements OnInit {
  checkedVal = false;
  // dates
