...
@Component({
  selector: 'app-emd-refund-voucher-detail-posting',
  templateUrl: './emd-refund-voucher-detail-posting.component.html',
  styleUrls: ['./emd-refund-voucher-detail-posting.component.css']
})
export class EmdRefundVoucherDetailPostingComponent implements OnInit {
