...
@Component({
  selector: 'app-upload-bank-scroll',
  templateUrl: './upload-bank-scroll.component.html',
  styleUrls: ['./upload-bank-scroll.component.css']
})
export class UploadBankScrollComponent implements OnInit {
  // FormGroup
  uploadBankForm: FormGroup;
  // FormControl
  ...
  // Display Columns
  displayedColumns: string[] = ['checkBox', 'date', 'sType', 'bank', 'bcode',
  ...
  ngOnInit() {
    this.uploadBankForm = this.fb.group({
      // FormGroup Fields
      passingDate: [''],
      type: ['Adjustment'],
      detailHead: ['1234'],
