...
@Component({
  selector: 'app-emd-received-add',
  templateUrl: './emd-received-add.component.html',
  styleUrls: ['./emd-received-add.component.css']
})

export class EmdReceivedAddComponent implements OnInit {
  // variables
  ...
  reset() {
    ...
    this.selectBill('1');
    this.emdReceivedForm.patchValue({
      subTLocation: '1',
      subTLocation1: '',
      type: '1',
      entryDate: '',
