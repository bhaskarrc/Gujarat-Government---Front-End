...
import { ObjectionMaster, ListValue } from 'src/app/model/treasury-bill';
...
@Component({
  ...
  selector: 'objection-dialog',
  templateUrl: 'objection-dialog.html',
})
...
export class objectiondialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<objectiondialogComponent>
  ) { }
  ngOnInit() {
