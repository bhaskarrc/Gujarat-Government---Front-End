...
import { TokennoPaoComponent } from 'src/app/pao/inward/inward-physical-bill/dialog/tokenno/tokenno.component';
...
export class InwardChequeComponent implements OnInit {
  ...
  // token no dialog
  tokenNo() {
    const dialogRef = this.dialog.open(TokennoPaoComponent, {
      width: '800px'
    });
