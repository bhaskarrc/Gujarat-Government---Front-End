...
@Component({
  selector: 'app-gi-statement-two',
  templateUrl: './gi-statement-two.component.html',
  styleUrls: ['./gi-statement-two.component.css']
})
export class GiStatementTwoComponent implements OnInit {

  directiveObject = new GroupInsuranceDirective(this.dialog);


  // Table Data for statement two table
