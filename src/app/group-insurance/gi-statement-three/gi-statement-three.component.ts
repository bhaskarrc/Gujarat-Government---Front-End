...
@Component({
  selector: 'app-gi-statement-three',
  templateUrl: './gi-statement-three.component.html',
  styleUrls: ['./gi-statement-three.component.css']
})
export class GiStatementThreeComponent implements OnInit {

  directiveObject = new GroupInsuranceDirective(this.dialog);


  // Table Data for statement three table
