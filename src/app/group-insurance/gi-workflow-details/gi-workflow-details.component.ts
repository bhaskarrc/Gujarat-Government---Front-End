...
@Component({
    selector: 'app-gi-workflow-details',
    templateUrl: './gi-workflow-details.component.html',
    styleUrls: ['./gi-workflow-details.component.css']
})
export class GiWorkflowDetailsComponent implements OnInit {
    ...
    // Table Data for Browse Attachment Table
    ...
    headerJso: HeaderElement[] = [
        { label: 'Major Head', value: '8011 Insurance Fund & Saving Fund' },
        { label: 'Name of Treasury office', value: 'District Treasury Office' },
        { label: 'Office Address', value: 'District Treasury office, Ahmedabad' },
        { label: 'District', value: 'Ahmedabad' },
        { label: 'Month & Year', value: 'June- 2020' },
    ...
    forwardDialog_history_list: any[] = [
        {
            ...
            role: 'Creator',
            date: '1/11/2019',
            comment: 'Please correct the Receipt and Expenditure amount as per Group wise or Employee wise Expenditure statement.'
        },
        {
            id: 2,
            userName: 'Kum. Heena P Joshi',
            designation: 'Office superintendent',
            role: 'Verifier',
            date: '10/11/2019',
            comment: 'We may approved'
        },
        {
            id: 3,
            userName: 'Shri J P Kelevala',
    ...
    user_list: ListValue[] = [
        { value: '1', viewValue: 'Shri M H Badheka (Account Officer –Class-1) ' },
    ];
    ...
    constructor(private elem: ElementRef,
        ...
        public dialogRef: MatDialogRef<GiWorkflowDetailsComponent>,
