...
import { GrantReleaseFromDataSource, GrantReleaseFromDataSourceCo, GrantReleaseFromDataSourceDdo, GrantReleaseFromSubDetailHead, GrantReleaseFromSubDetailHeadCO, GrantReleaseFromSubDetailHeadDDO, GrantReleaseFromSubDetailHeadData } from 'src/app/model/grant-release-from-administrative-department';
import { BrwoseDatagrant, ListValue } from 'src/app/model/common-grant';
@Component({
  selector: 'app-grant-release-from-administrative-department',
  templateUrl: './grant-release-from-administrative-department.component.html',
  styleUrls: ['./grant-release-from-administrative-department.component.css']
})
export class GrantReleaseFromAdministrativeDepartmentComponent implements OnInit {
  errorMessages;
  isTokentable = false;
  public toggleButton = true;
  showtabe = false;
  demandMajorHead: Boolean = false;
  demandSubHead: Boolean = true;
  ...
  ELEMENT_DATA: GrantReleaseFromDataSource[] = [
    {
      financeDepState: 100, fDCss: 50, grantState: 10,
      grantCss: 200,
      grantToDepState: 50,
      grantToDepCss: 50,
      grantToCoState: 40,
      grantToCoCss: 90, grantToDdoState: 80, grantToDdoCss: 76, remaningGrantState: 89,
      remaningGrantCss: 84,
      progressGrantState: 86, progressGrantCss: 85
    },
  ];
  ELEMENT_DATA_CO: GrantReleaseFromDataSourceCo[] = [
    {
      financeDepState: 100, fDCss: 50, grantState: 10,
      grantCss: 200,
      grantToDepState: 50,
  ...
  ELEMENT_DATA_DDO: GrantReleaseFromDataSourceDdo[] = [
    {
      financeDepState: 100, fDCss: 50, grantState: 10,
      grantCss: 200,
      grantToDepState: 50,
  ...
  SUBDETAILHEAD_CO: any[] = [
    {
      position: 1, budgetHead: '001:2404:00:800:02:00 Item 2 (New Item Estimate)', itemName: ' ',
      bEState: 1000, bECss: 500, rBEState: 10, rBECss: 90,
      grantApproState: 200, grantApproCss: 50, ControllinGOfficerName: 'CO 1', grantReleaseState: 356,
      grantReleaseCss: 120, avalilState: '10.0000',
      avalilCss: '10.0000',
      grantToBeReleaseState: '', grantToBeReleaseCss: '', toolTipData: 'Available Grant : 10.0000',
    },
    {
      position: 2, budgetHead: '001:2404:00:800:03:00 Item 1 (New Item Estimate)', itemName: ' ',
      bEState: 2000, bECss: 700, rBEState: 80, rBECss: 40,
      grantApproState: 207, grantApproCss: 50, ControllinGOfficerName: 'CO 1', grantReleaseState: 376,
      grantReleaseCss: 120, avalilState: '10.0000',
      avalilCss: '10.0000',
      grantToBeReleaseState: '', grantToBeReleaseCss: '', toolTipData: 'Available Grant : 10.0000',
    },
    {
      position: 2, budgetHead: '001:2404:00:800:03:00 Item 3 (New Item Estimate)', itemName: ' ',
      bEState: 1500, bECss: 600, rBEState: 40, rBECss: 20,
      grantApproState: 207, grantApproCss: 50, ControllinGOfficerName: 'CO 1', grantReleaseState: 356,
      grantReleaseCss: 100, avalilState: '10.0000',
      avalilCss: '10.0000',
      grantToBeReleaseState: '', grantToBeReleaseCss: '', toolTipData: 'Available Grant : 10.0000',
    },
  ];
  SUBDETAILHEAD_DDO: any[] = [
    {
      position: 1, budgetHead: '001:2404:00:800:01 :00 Item 2 (New Item Estimate)',
      bEState: 1000, bECss: 500, rBEState: 10, rBECss: 90,
      grantApproState: 200, grantApproCss: 50, ddoName: 'Under Secretary Cash branch, Finance Department', grantReleaseState: 356,
      grantReleaseCss: 120, avalilState: '10.0000', avalilCss: '10.0000',
      grantToBeReleaseState: '', grantToBeReleaseCss: '', toolTipData: '001:2404:00:800 :01:00 Item 2 (New Item Estimate)',
    },
    {
      position: 2, budgetHead: '001:2404:00:800:01 :00 Item 2 (New Item Estimate)',
      bEState: 2000, bECss: 700, rBEState: 80, rBECss: 40,
      grantApproState: 207, grantApproCss: 50, ControllinGOfficerName: 'CO 1', grantReleaseState: 376,
      grantReleaseCss: 170, avalilState: '10.0000', avalilCss: '10.0000',
      grantToBeReleaseState: '', grantToBeReleaseCss: '', toolTipData: '001:2404:00:800: 01:00 Item 2 (New Item Estimate)',
    }, {
      position: 2, budgetHead: '001:2404:00:800:01 :00 Item 3 (New Item Estimate)',
      bEState: 1500, bECss: 600, rBEState: 40, rBECss: 20,
      grantApproState: 207, grantApproCss: 50, ControllinGOfficerName: 'CO 1', grantReleaseState: 356,
      grantReleaseCss: 100, avalilState: '10.0000', avalilCss: '10.0000',
      grantToBeReleaseState: '', grantToBeReleaseCss: '', toolTipData: '001:2404:00:800: 01:00 Item 2 (New Item Estimate)',
    },
  ];
  DETAILHEAD: any[] = [
    {
      ...
      avalilState: '1500', avalilCss: '1500',
      avalilState1: '3000', avalilCss1: '3000',
      avalilState2: '4500.00', avalilCss2: '4500.00',
    },

    {
      ...
      detailHeadDiscriptionBtoolTip: '00:C2: Personal Service and Benefit ',
      detailHeadDiscriptionCtoolTip: '00:C3: Personal Service and Benefit ',
      avalilState: '1500', avalilCss: '3000',
      avalilState1: '1500', avalilCss1: '3000',
      avalilState2: '4500.00', avalilCss2: '4500.00',
    }
  ...
  displayedGrantColumns: string[] = [
    'financeDepState', 'fDCss',
    'grantState', 'grantCss', 'grantToDepState', 'grantToDepCss', 'grantToCoState', 'grantToCoCss', 'grantToDdoState',
    'grantToDdoCss', 'progressGrantState', 'progressGrantCss', 'remaningGrantState', 'remaningGrantCss'];
  displayedGrantColumnsCo: string[] = [
    'financeDepState', 'fDCss',
    'grantState', 'grantCss', 'grantToDepState', 'grantToDepCss', 'grantToCoState', 'grantToCoCss', 'grantToDdoState',
    'grantToDdoCss', 'remaningGrantState', 'remaningGrantCss'];
  displayedGrantColumnsDdo: string[] = [
    'financeDepState', 'fDCss',
    'grantState', 'grantCss', 'grantToDepState', 'grantToDepCss', 'grantToCoState', 'grantToCoCss', 'grantToDdoState',
    'grantToDdoCss', 'remaningGrantState', 'remaningGrantCss'];
  displayedSubDetailHeadColumns: string[] = [
    'position', 'budgetHead', 'bEState', 'bECss',
    'rBEState', 'rBECss', 'departmentName',
    'grantReleaseState', 'grantReleaseCss', 'avalilState', 'avalilCss',
    'grantToBeReleaseState', 'grantToBeReleaseCss', 'action'];
  displayedSubDetailHeadColumnsCo: string[] = [
    'position', 'budgetHead', 'bEState', 'bECss',
    'rBEState', 'rBECss',
    'grantApproState', 'grantApproCss', 'avalilState', 'avalilCss', 'ControllinGOfficerName',
    'grantReleaseState', 'grantReleaseCss', 'grantToBeReleaseState', 'grantToBeReleaseCss',
    'action'];
  displayedSubDetailHeadColumnsDdo: string[] = [
    'position', 'budgetHead', 'bEState', 'bECss',
    'rBEState', 'rBECss',
    'grantApproState', 'grantApproCss', 'avalilState', 'avalilCss', 'ddoName',
  ...
  grantdataSourceCo = new MatTableDataSource<any>(this.ELEMENT_DATA_CO);
  grantdataSourceDdo = new MatTableDataSource<any>(this.ELEMENT_DATA_DDO);
  subDetailHeadSource = new MatTableDataSource<any>(this.SUBDETAILHEAD);
  subDetailHeadSourceCo = new MatTableDataSource<any>(this.SUBDETAILHEAD_CO);
  subDetailHeadSourceDdo = new MatTableDataSource<any>(this.SUBDETAILHEAD_DDO);
  ...
  demandMajorHeadFun() {
    this.demandMajorHead = true;
    this.demandSubHead = false;
  }

  demandSubHeadFun() {
    this.demandMajorHead = true;
    this.demandSubHead = true;
  }
  ...
  officerList(): void {
    const dialogRef = this.dialog.open(GrantReleaseAdDepartmentDialogComponent, {
      width: '830px',
    });
  ...
  view() {
    const dialogRef = this.dialog.open(GrantviewDialog5Component, {
      width: '800px'
    });
  ...
  officerLists(): void {
    const dialogRef = this.dialog.open(GrantRecevedControllingOfficerDialogDDO2Component, {
      width: '830px',
    });
  ...
  grantApproState(): number {
    ...
    // tslint:disable-next-line:no-shadowed-variable
    this.subDetailHeadSource.data.forEach((element) => {
      calcCurrentCss = calcCurrentCss + Number(element.avalilState);
    });
    return calcCurrentCss;
  }
  grantApproCss(): number {
    ...
    // tslint:disable-next-line:no-shadowed-variable
    this.subDetailHeadSource.data.forEach((element) => {
      calcCurrentCss = calcCurrentCss + Number(element.avalilCss);
    });
    return calcCurrentCss;
  }
  ...
  getReleseavailTillDateState(): number {
    let calcCurrentCss = 0;
    // tslint:disable-next-line:no-shadowed-variable
    this.detailHeadeDataSource.data.forEach((element) => {
      calcCurrentCss = calcCurrentCss + Number(element.avalilState2);
    });
    return calcCurrentCss;
  }
  getReleseavailTillDateCss(): number {
    let calcCurrentCss = 0;
    // tslint:disable-next-line:no-shadowed-variable
    this.detailHeadeDataSource.data.forEach((element) => {
      calcCurrentCss = calcCurrentCss + Number(element.avalilCss2);
    });
    return calcCurrentCss;
  }
...
export class GrantReleaseAdDepartmentDialogComponent implements OnInit {
  department_list: ListValue[] = [
    { value: '1', viewValue: 'Finance Department' },
  ];
  ...
  constructor(
    public dialogRef: MatDialogRef<GrantReleaseAdDepartmentDialogComponent>,
...
export class GrantRecevedControllingOfficerDialogDDO2Component {
  department_list: any[] = [
    { value: '1', viewValue: 'Finance Department' },
  ];
  district_list: any[] = [
  ...
  districtCtrl: FormControl = new FormControl();
  constructor(
    public dialogRef: MatDialogRef<GrantRecevedControllingOfficerDialogDDO2Component>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData, private fb: FormBuilder) { }
  displayedColumns: string[] = ['srNo', 'grantOrderNo', 'budgetHead', 'cssGrantReceved', 'dateOfGrantReceved'];
...
export class GrantviewDialog5Component {
  SUBDETAILHEAD: any[] = [
    {
      position: ' 1',
      nameofuser: '',
  ...
  constructor(
    public dialogRef: MatDialogRef<GrantviewDialog5Component>
