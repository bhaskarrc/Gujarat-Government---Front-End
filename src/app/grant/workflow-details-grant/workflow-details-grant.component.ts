...
@Component({
  ...
  templateUrl: './workflow-details-grant.component.html',
  styleUrls: ['./workflow-details-grant.component.css']
})
export class WorkflowDetailsGrantComponent implements OnInit {
  ...
  constructor(private elem: ElementRef,
      ...
      public dialogRef: MatDialogRef<WorkflowDetailsGrantComponent>,
