...
import { WorkflowDetailsPdplaComponent } from 'src/app/pdpla/workflow-details-pdpla/workflow-details-pdpla.component';
...
export class PdplaDirectives {
    ...
    workflowDetails(): void {
        const dialogRef = this.dialog.open(WorkflowDetailsPdplaComponent, {
            width: '1200px',
        });
